...
const About = () => {
    return (
        <section className='container mx-auto lg:w-[80%] w-[90%] mb-20'>
            <div className="container mx-auto md:mb-10 text-center lg:my-2 text-blue-gray-900 md:flex items-center justify-evenly gap-x-10 relative">
