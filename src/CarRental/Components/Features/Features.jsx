...
export function FeatureSection() {
  return (
    <section className="py-10">
      <div className="container mx-auto md:mb-10 text-center lg:my-2 text-blue-gray-900 md:flex items-center justify-between relative">
        ...
        <div className="container mx-auto flex flex-col justify-center h-full px-8 text-center">
          <div className="my-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-center max-w-md mx-auto">
              <Link to={'/carList'}>
                <Button color="red" className="w-full md:max-w-fit bg-white text-blue-gray-900 iransans">
                  مشاهده خودرو ها
                </Button>
              </Link>
            </div>
